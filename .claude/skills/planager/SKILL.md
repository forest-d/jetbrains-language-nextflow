...
2. Check if `.plans/<slug>.html` already exists.
...
6. Save the approved plan to `.plans/<slug>.html` with `status: planning`.
...
1. Glob `.plans/*.html` and read the frontmatter of each.
